...
/* Actual period: 0.005 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0x7a120,
  .duty_cycle_counts = 0x3d090, .source_div = (timer_source_div_t) 0, .channel = 1, .p_callback =
          g_timer1_AGT_5ms_callback,
